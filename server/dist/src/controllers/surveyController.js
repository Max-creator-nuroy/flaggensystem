...
exports.getUnreadSurveysForCoach = exports.getUnreadSurveysForUser = exports.rescanSurveySchedules = exports.deleteSurveySchedule = exports.updateSurveySchedule = exports.createSurveySchedule = exports.getSurveySchedules = exports.broadcastCustomSurvey = exports.getSurveyCompletionRateForCustomersByCoach = exports.getSurveyCompletionRateForCoaches = exports.getSurveyCompletionRateForCustomers = exports.getCustomerSurveyByCoach = exports.getSurveyByAdmin = exports.submitSurveyAnswers = exports.createSurveyForUser = exports.deleteSurvey = exports.getSurveyById = exports.getCurrentSurvey = exports.getSurveysByUser = exports.createSurvey = void 0;
const client_1 = require("@prisma/client");
const questionController_1 = require("./questionController");
const surveyScheduler_1 = require("../cronJobs/surveyScheduler");
...
const getCurrentSurvey = async (req, res) => {
    const userId = req.params.userId;
    try {
...
const createSurveyForUser = async (req, res) => {
    ...
    if (!coachId)
        throw new Error("User hat keinen Coach");
...
exports.createSurveyForUser = createSurveyForUser;
// PATCH
const submitSurveyAnswers = async (req, res) => {
    ...
    try {
        ...
        const updates = await Promise.all(questions.map((q) => prisma.surveyQuestion.update({
            where: { id: q.id },
            data: {
                answer: q.answer,
                rating: q.rating,
...
exports.submitSurveyAnswers = submitSurveyAnswers;
// GET /survey/getSurveyByAdmin
const getSurveyByAdmin = async (req, res) => {
    try {
        const surveys = await prisma.survey.findMany({
            where: {
                user: {
...
exports.getSurveyByAdmin = getSurveyByAdmin;
// GET /survey/byCoach
const getCustomerSurveyByCoach = async (req, res) => {
    try {
...
exports.getCustomerSurveyByCoach = getCustomerSurveyByCoach;
//GET /surveys/getSurveyCompletionRateForCustomers
const getSurveyCompletionRateForCustomers = async (req, res) => {
    try {
...
exports.getSurveyCompletionRateForCustomers = getSurveyCompletionRateForCustomers;
const getSurveyCompletionRateForCoaches = async (req, res) => {
    try {
        const sevenDaysAgo = new Date();
        sevenDaysAgo.setDate(sevenDaysAgo.getDate() - 7);
...
exports.getSurveyCompletionRateForCoaches = getSurveyCompletionRateForCoaches;
//GET /surveys/getSurveyCompletionRateForCustomers
const getSurveyCompletionRateForCustomersByCoach = async (req, res) => {
    try {
...
exports.getSurveyCompletionRateForCustomersByCoach = getSurveyCompletionRateForCustomersByCoach;
// POST /surveys/broadcastCustomSurvey
// Body: { targetRole: 'COACH' | 'CUSTOMER', questions: [{text,isRating}], comment?: string }
const broadcastCustomSurvey = async (req, res) => {
    ...
    try {
        ...
        const createdQuestions = await (0, questionController_1.createTemporaryQuestions)(questions.map((q) => ({ text: q.text, isRating: !!q.isRating })));
        ...
        await prisma.$transaction(users.map((u) => prisma.survey.create({
            data: {
                userId: u.id,
...
exports.broadcastCustomSurvey = broadcastCustomSurvey;
// 🆕 ----- Survey Schedule Management -----
const getSurveySchedules = async (_req, res) => {
    try {
        const schedules = await prisma.surveySchedule.findMany({ orderBy: { createdAt: "desc" } });
        res.json(schedules);
    }
    catch (err) {
...
exports.getSurveySchedules = getSurveySchedules;
const createSurveySchedule = async (req, res) => {
    try {
        const { type, cronExpression, timezone, active, comment } = req.body;
        if (!type || !cronExpression)
            return res.status(400).json({ error: "type und cronExpression erforderlich" });
        ...
        await (0, surveyScheduler_1.startDynamicSurveyCronJobs)();
...
exports.createSurveySchedule = createSurveySchedule;
const updateSurveySchedule = async (req, res) => {
    try {
        const { id } = req.params;
        const { type, cronExpression, timezone, active, comment } = req.body;
        const schedule = await prisma.surveySchedule.update({
            where: { id },
...
const deleteSurveySchedule = async (req, res) => {
    try {
        const { id } = req.params;
        await prisma.surveySchedule.delete({ where: { id } });
        await (0, surveyScheduler_1.startDynamicSurveyCronJobs)();
        res.json({ ok: true });
    }
    catch (err) {
...
exports.deleteSurveySchedule = deleteSurveySchedule;
const rescanSurveySchedules = async (_req, res) => {
    try {
        await (0, surveyScheduler_1.startDynamicSurveyCronJobs)();
        res.json({ ok: true });
    }
...
exports.rescanSurveySchedules = rescanSurveySchedules;
// GET /surveys/user/unread - For customers to get unread surveys
const getUnreadSurveysForUser = async (req, res) => {
    try {
...
exports.getUnreadSurveysForUser = getUnreadSurveysForUser;
// GET /surveys/coach/unread - For coaches to get unread surveys from admin
const getUnreadSurveysForCoach = async (req, res) => {
    try {
...
exports.getUnreadSurveysForCoach = getUnreadSurveysForCoach;
