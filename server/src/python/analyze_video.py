...
max_images = 400  # Anzahl der Frames, die du verwenden willst
...
def build_prompt(criteria):
    base = "Please analyze the following sequence of video frames and answer the following questions with 'true' or 'false' in a JSON format - { id: <ID>, answer: true } if the video clearly fulfills the criterion\n:\n\n"
